...
const IndexPage = () => {
  return (
    <body>
      ...
      <a href="https://www.zagdrath.xyz/">by Cody Wellman</a>
      ...
      <pre>slmgr /ato</pre>
      <p>If you have any questions or need any help you can reach me at my website <a href="https://www.zagdrath.xyz/">zagdrath.xyz</a>.</p>
      <hr></hr>
      <p>Copyright (C) 2022, Cody Wellman. All Rights Reserved.</p>
    </body>
  )
}
